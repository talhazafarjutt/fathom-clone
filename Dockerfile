...
# Migrations plus the small runner that replays them. The Prisma CLI is not
# shipped: it eagerly loads Studio and its dev server, which is over 250 MB for
# an image that only needs to execute SQL. See scripts/migrate.mjs.
